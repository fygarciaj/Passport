...
namespace Fygarciaj\Passport\Guards;
...
use Fygarciaj\Passport\TransientToken;
...
class TokenGuard
{
    ...
    /**
     * The Database user Provider implementation
     *
     ...
     * @param  \Fygarciaj\Passport\TokenRepository  $tokens
    ...
    protected function authenticateViaBearerToken($request)
    {
        ...
        // TODO: esto hay que redefinirlo
        $user = new User;

        $user->setConnection(Passport::getConnection());

        $user = $user->find($psr->getAttribute('oauth_user_id') ?: null);
