...
class Passport
{
    ...
    /**
     *  Indicates the conection for database
     *
     * @var string|null
     */
     ...
     * @var string
     */
    public static $authCodeModel = 'Fygarciaj\Passport\AuthCode';
     ...
     * @var string
     */
    public static $clientModel = 'Fygarciaj\Passport\Client';
     ...
     * @var string
     */
    public static $personalAccessClientModel = 'Fygarciaj\Passport\PersonalAccessClient';
     ...
     * @var string
     */
    public static $tokenModel = 'Fygarciaj\Passport\Token';
     ...
     *
     * @param  \Illuminate\Contracts\Auth\Authenticatable|\Fygarciaj\Passport\HasApiTokens  $user
     * @param  array  $scopes
     * @param  string  $guard
     ...
     *
     * @return \Fygarciaj\Passport\AuthCode
     */
     ...
     *
     * @return \Fygarciaj\Passport\PersonalAccessClient
     */
